...
public class AdvancedCriteriaQueryTestSuite extends JUnitTestCase {
    ...
    public static Test suite() {
        ...
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExists"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryNotExists"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExistsAfterAnd"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExistsBeforeAnd"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryNotExistsAfterAnd"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryNotExistsBeforeAnd"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExistsNested"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExistsNestedUnusedRoot"));
        suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExistsNestedAfterAnd"));
        //CUBA tests: suite.addTest(new AdvancedCriteriaQueryTestSuite("testSubqueryExistsNestedAfterLiteralAnd"));
